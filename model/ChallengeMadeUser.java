...
public class ChallengeMadeUser {
	...
	private String name;
	public ChallengeMadeUser(int idChallenge, String nameChallenge, String intruduce, String imageLink, int frequency,
			int possibleStartTime, int possibleEndTime, int count, String countInterval, int challengePostCount,
			int madeIdUser, String name) {
		super();
